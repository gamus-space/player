...
ChiptuneJsPlayer.prototype.setCurrentTime = function (t) {
  return libopenmpt._openmpt_module_set_position_seconds(this.currentPlayingNode.modulePtr, t);
};
...
ChiptuneJsPlayer.prototype.getSelectedSubsong = function () {
...
ChiptuneJsPlayer.prototype.selectSubsong = function (s) {
  return libopenmpt._openmpt_module_select_subsong(this.currentPlayingNode.modulePtr, s);
};
...
ChiptuneJsPlayer.prototype.setRepeatCount = function(v) {
  if (!this.currentPlayingNode.modulePtr) return;
  libopenmpt._openmpt_module_set_repeat_count(this.currentPlayingNode.modulePtr, v);
}

ChiptuneJsPlayer.prototype.setStereoSeparation = function(v) {
  if (!this.currentPlayingNode.modulePtr) return;
  libopenmpt._openmpt_module_set_render_param(this.currentPlayingNode.modulePtr, OPENMPT_MODULE_RENDER_STEREOSEPARATION_PERCENT, v);
}

ChiptuneJsPlayer.prototype.setMasterGain = function(v) {
  if (!this.currentPlayingNode.modulePtr) return;
  libopenmpt._openmpt_module_set_render_param(this.currentPlayingNode.modulePtr, OPENMPT_MODULE_RENDER_MASTERGAIN_MILLIBEL, v);
}
